...
- Using `git` from the command line
  - [Installing and using `git` (Part 1)](https://www.youtube.com/watch?v=ng4X6qF8XVY)
  - [Merge conflicts and branching (Part 2)](https://youtu.be/Nk1gtrbTZ2Y)

- [Using `git` with GitHub Desktop](https://youtu.be/zQc5vQEBips)

- [GIT & GITHUB TUTORIAL](https://www.youtube.com/watch?v=xuB1Id2Wxak)
  - with [notes](https://docs.google.com/document/d/1GAdkvn7lWzeLekvC343WNZC2rZGhQOfPOU2dMha9aws/edit)

- [Personal Access Token Tutorial](https://docs.google.com/document/d/1XkcwMUZiHz_jtQ0cOiKXOpko8TCMhXKqPbs_qiFg8hM/edit?tab=t.0)
...
- [NLP in Python](https://www.youtube.com/watch?v=xvqsFTUsOmc)
...
- [Mathematical Underpinnings](https://www.youtube.com/watch?v=PPLop4L2eGk&list=PLLssT5z_DsK-h9vYZkQkYNWcItqhlRJLN)
- [Keras & TensorFlow](https://www.youtube.com/watch?v=tPYj3fFJGjk)
- [ML / DL / RL / NLP Resource Hub](https://github.com/ahmedbahaaeldin/From-0-to-Research-Scientist-resources-guide)
